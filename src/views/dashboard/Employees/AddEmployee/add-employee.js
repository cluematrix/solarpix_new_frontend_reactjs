...
const AddEmployee = () => {
  ...
  // useEffect(() => {
  //   const randomId = `Solar${String(Math.floor(Math.random() * 1000)).padStart(
  //     3,
  //     "0"
  //   )}`;
  //   setFieldValue("emp_id", randomId);
  //   // setFieldValue("reporting_to", randomId);
  // }, [setFieldValue]);
  ...
  console.log("reporting_to", values.reporting_to);
  return (
    <Card>
      <Card.Header>
