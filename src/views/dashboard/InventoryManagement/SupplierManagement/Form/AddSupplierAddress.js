        ...
        <Row>
          <Col md={4}>
            <CustomInput
              label="City"
              name="billing_city"
              value={formik.formik?.values.billing_city}
          ...
          <Col md={4}>
            <CustomInput
              label="State"
              name="billing_state"
              value={formik.formik?.values.billing_state}
              onChange={formik.formik?.handleChange}
              onBlur={formik.formik?.handleBlur}
          ...
          <Col md={4}>
            <CustomInput
              ...
              value={formik.formik?.values.billing_address}
              onChange={formik.formik?.handleChange}
              onBlur={formik.formik?.handleBlur}
        ...
        <Row className="mt-3">
          <Col md={4}>
            <CustomInput
              ...
              value={formik.formik?.values.billing_pincode}
              onChange={formik.formik?.handleChange}
              onBlur={formik.formik?.handleBlur}
          ...
          <Col md={4}>
            <CustomInput
              label="Phone"
              name="billing_phone"
              value={formik.formik?.values.billing_phone}
              onChange={formik.formik?.handleChange}
              onBlur={formik.formik?.handleBlur}
        ...
        <Row>
          <Col md={4}>
            <CustomInput
              label="City"
              name="shipping_city"
              value={formik.formik?.values.shipping_city}
              onChange={formik.formik?.handleChange}
              onBlur={formik.formik?.handleBlur}
          ...
          <Col md={4}>
            <CustomInput
              label="State"
              name="shipping_state"
              value={formik.formik?.values.shipping_state}
              onChange={formik.formik?.handleChange}
              onBlur={formik.formik?.handleBlur}
          ...
          <Col md={4}>
            <CustomInput
              ...
              value={formik.formik?.values.shipping_address}
              onChange={formik.formik?.handleChange}
              onBlur={formik.formik?.handleBlur}
        ...
        <Row className="mt-3">
          <Col md={4}>
            <CustomInput
              ...
              value={formik.formik?.values.shipping_pincode}
              onChange={formik.formik?.handleChange}
              onBlur={formik.formik?.handleBlur}
          ...
          <Col md={4}>
            <CustomInput
              label="Phone"
              name="shipping_phone"
              value={formik.formik?.values.shipping_phone}
              onChange={formik.formik?.handleChange}
              onBlur={formik.formik?.handleBlur}
