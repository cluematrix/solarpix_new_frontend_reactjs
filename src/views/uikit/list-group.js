...
import { ListGroup, ListGroupItem, Nav, Tab, Button } from "react-bootstrap";
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-flex align-items-center mt-2">
                <Button
                  bsPrefix=" d-flex"
                  href="https://templates.iqonic.design/hope-ui/documentation/react/build/listgroup"
                  target="_blank"
                >
                  <svg
                    width="20"
          ...
          <Tab.Container defaultActiveKey="first">
              ...
              <Nav as="ul" className=" nav-tabs nav-tunnel nav-slider">
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    className={
                      toggleState === true
                        ? "tabs active"
                        : "tabs d-flex align-items-center"
                    }
                    onClick={() => setToggleState(true)}
                    data-bs-toggle="tab"
                    data-bs-target="#content-listgroup-prv"
                    type="button"
                    role="tab"
                ...
                <Nav.Item as="li" role="presentation">
                  <Nav.Link
                    ...
                    data-bs-toggle="tab"
                    data-bs-target="#content-listgroup-code"
                    type="button"
                    role="tab"
            ...
            <Tab.Content>
              <Tab.Pane
                eventKey="first"
                className={
                  toggleState === true ? "content  active-content" : "content"
                }
                id="content-listgroup-prv"
                role="tabpanel"
                aria-labelledby="typo-output"
              >
                <div className="bg-example">
                  <ListGroup as="ul">
                    <ListGroup.Item as="li" active aria-current="true">
                      An active item
                    </ListGroup.Item>
                ...
                <div className="bd-example pt-2">
                  <ListGroup>
                    ...
                    <ListGroupItem href="#" action variant="primary">
                      A simple primary list group item
                    </ListGroupItem>
                    <ListGroupItem href="#" action variant="secondary">
                      A simple secondary list group item
                    </ListGroupItem>
                    <ListGroupItem href="#" action variant="success">
                      A simple success list group item
                    </ListGroupItem>
                    <ListGroupItem href="#" action variant="danger">
                      A simple danger list group item
                    </ListGroupItem>
                    <ListGroupItem href="#" action variant="warning">
                      A simple warning list group item
                    </ListGroupItem>
                    <ListGroupItem href="#" action variant="info">
                      A simple info list group item
                    </ListGroupItem>
                    <ListGroupItem href="#" action variant="light">
                      A simple light list group item
                    </ListGroupItem>
                    <ListGroupItem href="#" action variant="dark">
                      A simple dark list group item
                    </ListGroupItem>
                    <ListGroupItem href="#" action variant="gray">
                      A simple dark list group item
                    </ListGroupItem>
                  </ListGroup>
                </div>
                  ...
                  <ListGroup>
                    ...
                    >
                      <div className="d-flex w-100 justify-content-between">
                        <h5 className="mb-1"> group item heading</h5>
